/* ************************************************************************ */
/* This script computes the hashes of images of the keys of banks keyboards */
/* ************************************************************************ */


/* ******************* */
/*     BOURSORAMA       /
 * css selector to get key images :
 * document.querySelector("[data-matrix-list-item-index='4'] button img").src
*/

const boursoramaKeyImages = {
...
const boursoramaKeyImageHashes = {}
for (const key in boursoramaKeyImages) {
    const imageData = boursoramaKeyImages[key];
    boursoramaKeyImageHashes[key] = hashCode(imageData);
}
