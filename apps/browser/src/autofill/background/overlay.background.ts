...
export class OverlayBackground implements OverlayBackgroundInterface {
  ...
  async updateOverlayCiphers(
    ...
    if (authStatus === AuthenticationStatus.Unlocked) {
      ...
      this.updateOverlayCiphers$.next({ updateAllCipherTypes, refocusField, searchValue });
    }
  }
  ...
  async handleOverlayCiphersUpdate({
    ...
    await this.updateInlineMenuListCiphers(currentTab, searchValue);
   ...
   */
  private async updateInlineMenuListCiphers(tab: chrome.tabs.Tab, searchValue?: string) {
  ...
  private getInlineMenuTranslations() {
    if (!this.inlineMenuPageTranslations) {
      const cozyTranslationKeys = [
        ...
        "cell",
        "viewMoreContact",
        "viewMoreContactInfo1",
        "viewMoreContactInfo2",
        "viewMoreContactRedirect",
        "contactSearch",
        "empty_email",
        "empty_phone",
        "empty_address",
        ...
        "autofill_identityLastName",
        "autofill_contactSurname",
        "autofill_contactJobTitle",
        "autofill_contactBirthDay",
        "autofill_contactBirthMonth",
        "autofill_contactBirthYear",
        "autofill_addressNumber",
        "autofill_identityFullName",
        "autofill_identityAddress1",
        "autofill_identityAddress2",
        "autofill_identityAddress3",
        "autofill_identityCity",
        "autofill_identityState",
        "autofill_identityPostalCode",
        "autofill_identityCountry",
        "autofill_identityCompany",
