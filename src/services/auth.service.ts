...
export class AuthService extends BaseAuthService {
  ...
  clear(): Promise<void> {
    return this._cozyClientService.deleteOAuthClient(this.clientId, this.registrationAccessToken);
  }
  ...
  async logIn(email: string, masterPassword: string): Promise<AuthResult> {
    ...
    const localHashedPassword = await this._cryptoService.hashPassword(
      masterPassword,
      key,
      HashPurpose.LocalAuthorization
    );
    return await this._logInHelper(
      email,
      hashedPassword,
      localHashedPassword,
      null,
  ...
  private async _logInHelper(
    ...
    await this._userService.setInformation(
